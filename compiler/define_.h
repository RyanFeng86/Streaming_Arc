...
//weight_stream_depth
const int w1_stream_depth=117;
const int w2_stream_depth=162;
const int w3_stream_depth=90;
const int w4_stream_depth=180;
const int w5_stream_depth=108;
const int w6_stream_depth=216;
const int w7_stream_depth=216;
const int w8_stream_depth=144;
const int w9_stream_depth=288;
const int w10_stream_depth=288;
const int w11_stream_depth=144;
const int w12_stream_depth=144;
const int w13_stream_depth=144;
const int w14_stream_depth=64;
const int w15_stream_depth=64;
const int w16_stream_depth=512;

//IFM_stream_depth
const int ifm_1_stream_depth=578;
const int ifm_2_stream_depth=1156;
const int ifm_3_stream_depth=324;
const int ifm_4_stream_depth=648;
const int ifm_5_stream_depth=200;
const int ifm_6_stream_depth=400;
const int ifm_7_stream_depth=400;
const int ifm_8_stream_depth=144;
const int ifm_9_stream_depth=288;
const int ifm_10_stream_depth=288;
const int ifm_11_stream_depth=128;
const int ifm_12_stream_depth=128;
const int ifm_13_stream_depth=96;
const int ifm_14_stream_depth=32;
const int ifm_15_stream_depth=32;
const int ifm_16_stream_depth=256;

//IFM_gen_stream_depth
const int ifm_1_gen_stream_depth=13;
const int ifm_2_gen_stream_depth=18;
const int ifm_3_gen_stream_depth=10;
const int ifm_4_gen_stream_depth=20;
const int ifm_5_gen_stream_depth=12;
const int ifm_6_gen_stream_depth=24;
const int ifm_7_gen_stream_depth=24;
const int ifm_8_gen_stream_depth=16;
const int ifm_9_gen_stream_depth=32;
const int ifm_10_gen_stream_depth=32;
const int ifm_11_gen_stream_depth=16;
const int ifm_12_gen_stream_depth=16;
const int ifm_13_gen_stream_depth=16;
const int ifm_14_gen_stream_depth=64;
const int ifm_15_gen_stream_depth=64;
const int ifm_16_gen_stream_depth=512;

//OFM_result_depth
const int mul_1_result_stream_depth=4;
const int mul_2_result_stream_depth=64;
const int mul_3_result_stream_depth=8;
const int mul_4_result_stream_depth=64;
const int mul_5_result_stream_depth=16;
const int mul_6_result_stream_depth=16;
const int mul_7_result_stream_depth=64;
const int mul_8_result_stream_depth=32;
const int mul_9_result_stream_depth=32;
const int mul_10_result_stream_depth=64;
const int mul_11_result_stream_depth=32;
const int mul_12_result_stream_depth=32;
const int mul_13_result_stream_depth=32;
const int mul_14_result_stream_depth=8;
const int mul_15_result_stream_depth=8;
const int mul_16_result_stream_depth=1;

//Pooling_result_depth
const int pooling_1_result_stream_depth=0;
const int pooling_2_result_stream_depth=32;
const int pooling_3_result_stream_depth=0;
const int pooling_4_result_stream_depth=32;
const int pooling_5_result_stream_depth=0;
const int pooling_6_result_stream_depth=0;
const int pooling_7_result_stream_depth=32;
const int pooling_8_result_stream_depth=0;
const int pooling_9_result_stream_depth=0;
const int pooling_10_result_stream_depth=16;
const int pooling_11_result_stream_depth=0;
const int pooling_12_result_stream_depth=0;
const int pooling_13_result_stream_depth=96;
const int pooling_14_result_stream_depth=0;
const int pooling_15_result_stream_depth=0;
const int pooling_16_result_stream_depth=0;
